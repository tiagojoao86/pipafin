...
public class AccountCategoryRest extends BaseRest<AccountCategoryBusiness, AccountCategoryDAO, AccountCategoryEntity, AccountCategoryGridDTO, AccountCategoryDTO, AccountCategoryFilterDTO, AccountCategoryRepository> {
}
