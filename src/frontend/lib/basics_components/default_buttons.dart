...
class DefaultButtons {
  ...
  static Widget mainMenuButton(VoidCallback cbFunction, String text, Icon icon) {
    return Padding(
      ...
      child: ElevatedButton.icon(
        ...
        icon: icon,
        label: TextUtil.label(text, foreground: DefaultColors.white1,),
      )
    ); //#7b9ecf // #5f83b3
  }

  static Widget buttonAdd(VoidCallback cbFunction) {
    return _createInkedButton(
        cbFunction,
        DefaultColors.greenAdd,
        DefaultColors.white1,
  ...
  static Widget deleteButton(VoidCallback cbFunction) {
    return _createInkedButton(
        cbFunction,
        DefaultColors.redRemove,
        DefaultColors.white1,
        const Icon(CupertinoIcons.trash_slash)
    );
  }
  ...
  static Widget formSaveButton(VoidCallback cbFunction, String text) {
    return Padding(
        ...
        child: ElevatedButton.icon(
          ...
          label: TextUtil(text, foreground: DefaultColors.white1,),
        )
    );
  }
  ...
  static Widget _createInkedButton(VoidCallback cbFunction, Color backgroundColor, Color iconColor, Icon icon) {
    return Padding(
